...
from hospitalSystem.models.base import BaseModel
from hospitalSystem.error import Error
from hospitalSystem.utils import get_locale
from hospitalSystem.utils.fop import req_2_sql, result_2_objs
from hospitalSystem.const import MAX_CREATION
...
class I18NResource(BaseResource):
